...
func LoginUser(c *gin.Context) {
	...
	c.SetCookie("Auth", token, 9000, "/", "https://task-app-amvt.onrender.com/", false, false)
	c.SetCookie("CheckAuth", "SiAutentico", 9000, "/", "https://task-app-amvt.onrender.com/", false, false)
